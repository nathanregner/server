...
export class Elasticsearch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:elasticsearch.k8s.elastic.co/v1beta1:Elasticsearch';
    ...
    public readonly apiVersion!: pulumi.Output<"elasticsearch.k8s.elastic.co/v1beta1" | undefined>;
    public readonly kind!: pulumi.Output<"Elasticsearch" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * ElasticsearchSpec holds the specification of an Elasticsearch cluster.
     */
    public readonly spec!: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchSpec | undefined>;
    /**
     * ElasticsearchStatus defines the observed state of Elasticsearch
     */
    public readonly status!: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchStatus | undefined>;
