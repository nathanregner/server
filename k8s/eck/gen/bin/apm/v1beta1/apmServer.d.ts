...
export declare class ApmServer extends pulumi.CustomResource {
    ...
    readonly apiVersion: pulumi.Output<"apm.k8s.elastic.co/v1beta1" | undefined>;
    readonly kind: pulumi.Output<"ApmServer" | undefined>;
    readonly metadata: pulumi.Output<ObjectMeta | undefined>;
    /**
     * ApmServerSpec holds the specification of an APM Server.
     */
    readonly spec: pulumi.Output<outputs.apm.v1beta1.ApmServerSpec | undefined>;
    /**
     * ApmServerStatus defines the observed state of ApmServer
     */
    readonly status: pulumi.Output<outputs.apm.v1beta1.ApmServerStatus | undefined>;
    /**
...
export interface ApmServerArgs {
     ...
     * ApmServerSpec holds the specification of an APM Server.
     */
    spec?: pulumi.Input<inputs.apm.v1beta1.ApmServerSpecArgs>;
    /**
     * ApmServerStatus defines the observed state of ApmServer
     */
    status?: pulumi.Input<inputs.apm.v1beta1.ApmServerStatusArgs>;
}
