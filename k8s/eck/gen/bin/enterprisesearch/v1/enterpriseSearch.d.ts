...
export declare class EnterpriseSearch extends pulumi.CustomResource {
    ...
    readonly apiVersion: pulumi.Output<"enterprisesearch.k8s.elastic.co/v1" | undefined>;
     ...
     */
    readonly spec: pulumi.Output<outputs.enterprisesearch.v1.EnterpriseSearchSpec | undefined>;
    /**
     * EnterpriseSearchStatus defines the observed state of EnterpriseSearch
     */
    readonly status: pulumi.Output<outputs.enterprisesearch.v1.EnterpriseSearchStatus | undefined>;
    /**
...
export interface EnterpriseSearchArgs {
     ...
     * EnterpriseSearchSpec holds the specification of an Enterprise Search resource.
     */
    spec?: pulumi.Input<inputs.enterprisesearch.v1.EnterpriseSearchSpecArgs>;
    /**
     * EnterpriseSearchStatus defines the observed state of EnterpriseSearch
     */
    status?: pulumi.Input<inputs.enterprisesearch.v1.EnterpriseSearchStatusArgs>;
}
