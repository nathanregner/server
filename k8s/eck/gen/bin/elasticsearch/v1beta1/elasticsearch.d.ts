...
export declare class Elasticsearch extends pulumi.CustomResource {
    ...
    readonly apiVersion: pulumi.Output<"elasticsearch.k8s.elastic.co/v1beta1" | undefined>;
    readonly kind: pulumi.Output<"Elasticsearch" | undefined>;
    readonly metadata: pulumi.Output<ObjectMeta | undefined>;
    /**
     * ElasticsearchSpec holds the specification of an Elasticsearch cluster.
     */
    readonly spec: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchSpec | undefined>;
    /**
     * ElasticsearchStatus defines the observed state of Elasticsearch
     */
    readonly status: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchStatus | undefined>;
    /**
...
export interface ElasticsearchArgs {
     ...
     * ElasticsearchSpec holds the specification of an Elasticsearch cluster.
     */
    spec?: pulumi.Input<inputs.elasticsearch.v1beta1.ElasticsearchSpecArgs>;
    /**
     * ElasticsearchStatus defines the observed state of Elasticsearch
     */
    status?: pulumi.Input<inputs.elasticsearch.v1beta1.ElasticsearchStatusArgs>;
}
