...
export declare class Kibana extends pulumi.CustomResource {
    ...
    readonly apiVersion: pulumi.Output<"kibana.k8s.elastic.co/v1" | undefined>;
    readonly kind: pulumi.Output<"Kibana" | undefined>;
    readonly metadata: pulumi.Output<ObjectMeta | undefined>;
    /**
     * KibanaSpec holds the specification of a Kibana instance.
     */
    readonly spec: pulumi.Output<outputs.kibana.v1.KibanaSpec | undefined>;
    /**
     * KibanaStatus defines the observed state of Kibana
     */
    readonly status: pulumi.Output<outputs.kibana.v1.KibanaStatus | undefined>;
    /**
...
export interface KibanaArgs {
     ...
     * KibanaSpec holds the specification of a Kibana instance.
     */
    spec?: pulumi.Input<inputs.kibana.v1.KibanaSpecArgs>;
    /**
     * KibanaStatus defines the observed state of Kibana
     */
    status?: pulumi.Input<inputs.kibana.v1.KibanaStatusArgs>;
}
